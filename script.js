...
function getWeatherData(city, unit, hourlyorweek) {
   const apikey = "UTLAZ3PT8V8TSESZ9YVF4CW6T";
    ...
    .catch((err) => {
        alert("City is not found in our database");
    });
}
...
function updateVisibilityStatus(visibility) {
    if (visibility <= 0.3) {
        visibilityStatus.innerText = "Derse Fog";
    }
